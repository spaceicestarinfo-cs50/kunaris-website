...
export default function SiteHeader({active="",locale="en"}){
  ...
  return <header className="siteHeader unifiedHeader">
    ...
    <nav className="mainNav">
      <div className={"navDrop "+(open==="you"?"isOpen":"")} onMouseEnter={()=>setOpen("you")} onMouseLeave={close}>
      ...
      <div className={"navDrop "+(open==="business"?"isOpen":"")} onMouseEnter={()=>setOpen("business")} onMouseLeave={close}>
      ...
      <div className={"navDrop "+(open==="projects"?"isOpen":"")} onMouseEnter={()=>setOpen("projects")} onMouseLeave={close}>
      ...
      <div className={"langDrop "+(open==="lang"?"isOpen":"")} onMouseEnter={()=>setOpen("lang")} onMouseLeave={close}>
