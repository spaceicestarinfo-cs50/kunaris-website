  ...
  return <header className="siteHeader unifiedHeader" onMouseLeave={close}>
    ...
    <nav className="mainNav">
      ...
      <div className={"navDrop "+(open==="projects"?"isOpen":"")} onMouseEnter={()=>setOpen("projects")}>
        ...
        <div className="navMenu"><a href={`${prefix}/projects#learning`}>{labels.learning}</a><a href={`${prefix}/projects#stories`}>{labels.stories}</a><a href={`${prefix}/projects#community`}>{labels.community}</a></div>
      </div>
