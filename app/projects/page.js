export default function ProjectsPage(){
  return <main className="projectsPage">
    <header className="subHeader">
      ...
      <nav><a href="/for-you">For You</a><a href="/for-business">For Your Business</a><a className="active" href="/projects">Projects &amp; Community</a><a href="/#circle">Kunaris Circle</a><a href="/#about">About</a><a href="mailto:hello@kunaris.ca">Contact</a><a className="signIn" href="/#circle">Sign In ↗</a><button className="lang">EN⌄</button></nav>
    </header>
