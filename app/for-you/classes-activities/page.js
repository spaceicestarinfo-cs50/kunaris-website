export default function ClassesActivitiesPage(){
 return <main className="activitiesPage">
  <header className="subHeader activitiesHeader">
   ...
   <nav><a className="active" href="/for-you">For You</a><a href="/for-business">For Your Business</a><a href="/projects">Projects</a><a href="/circle">Kunaris Circle</a><a href="/about">About</a><a href="/contact">Contact</a><a href="/circle">Kunaris Circle</a><button className="lang">EN⌄</button></nav>
  </header>
